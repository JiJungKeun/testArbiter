        ...
        protected void onProgressUpdate(Integer... progress) {
            ...
            if (keepDownloading) {
                ...
                if (showSysMessage[0]) {
                    ...
                    Toast.makeText(activity, startedDownloading + " " + fileNameStrNoExt + "!", Toast.LENGTH_SHORT).show();
                ...
                if (progress[0] > 99.9 && showSysMessage[1]) {
                    ...
                    Toast.makeText(activity, finishedDownloading + " " + fileNameStrNoExt + "!", Toast.LENGTH_SHORT).show();
